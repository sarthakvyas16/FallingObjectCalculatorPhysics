function inputCheck() {
    ...
    rhoKonstantStatus = document.getElementById("Air density constant checkbox").checked;
    tvmaxStatus = document.getElementById("Terminal velocity max checkbox").checked;
    k = 0.5 * cw * A * rho;
}
...
function writeTable() {
    ...
    document.write(
        "<tr><th>Time Δt [s]  </th><th>Velocity v [m/s]  </th><th>Height h [m]  </th><th>Force F [N]  </th><th>Acceleration a [m/s^2]  </th></tr>"
    );
...
function plotData() {
    ...
    trace5 = {
        ...
        y: vmax_arr,
        mode: "lines",
        name: "Terminal velocity v_max [m/s]",
        line: {
            shape: "spline",
            color: "#000000",
        },
